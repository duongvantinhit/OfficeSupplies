...
export class CrudCategoryComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.parentCategories = Object.values(ParentCategoryEnum);
  ...
  private formValidate(): any[] {
    ...
    if (!this.categoryForm.controls?.categoryDescription?.valid) {
      errorMessages.push(AppMessages.PLEASE_ENTER('Danh mục cha', Notice.messageEnter));
    }
  ...
  create(): void {
    ...
    formUploadImg.append('Parent', this.categoryForm.controls.parent.value);
